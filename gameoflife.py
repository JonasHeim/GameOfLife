...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        for i in range(500):
            self.current_matrix[random.randint(0, num_cell_x-1)][random.randint(0, num_cell_y-1)] = 1
    ...
    def get_living_neighbours_wrap_edges(self, pos_x, pos_y):
        ...
        if 0 == pos_x:
            ...
            if 0 == pos_y:
                ...
                if 0 != self.current_matrix[num_cell_x-1][num_cell_y-1]:
                    retval += 1
            else:
                #Simple left edge, so wrap around x
                if 0 != self.current_matrix[num_cell_x-1][pos_y-1]:
                    retval += 1
        elif 0 == pos_y:
            #We are on top edge, so wrap around y
            if 0 != self.current_matrix[pos_x-1][num_cell_y-1]:
                retval += 1
        else:
            #No edge cell
            if 0 != self.current_matrix[pos_x-1][pos_y-1]:
        ...
        if 0 == pos_y:
            #We are on top edge, so wrap around y
            if 0 != self.current_matrix[pos_x][num_cell_y-1]:
                retval += 1
        else:
            #No edge cell
            if 0 != self.current_matrix[pos_x][pos_y-1]:
        ...
        if num_cell_x-1 == pos_x:
            ...
            if 0 == pos_y:
                ...
                if 0 != self.current_matrix[0][num_cell_y-1]:
                    retval += 1
            else:
        ...
        if 0 == pos_x:
            ...
            if 0 != self.current_matrix[num_cell_x-1][pos_y]:
                retval += 1
        else:
            #No edge cell
            if 0 != self.current_matrix[pos_x-1][pos_y]:
        ...
        if 0 == pos_x:
            ...
            if (num_cell_y-1) == pos_y:
                ...
                if 0 != self.current_matrix[num_cell_x-1][0]:
                    retval += 1
            else:
                #Simple left edge, so wrap around x
                if 0 != self.current_matrix[num_cell_x-1][pos_y+1]:
